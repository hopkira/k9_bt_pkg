...
class BlackboardKey:
    ...
    CHESS_HUMAN_COLOUR = "chess/human_colour"
    CHESS_K9_COLOUR = "chess/k9_colour"
    ...
    CHESS_FEN = "chess/fen"
    CHESS_PLY = "chess/ply"
    CHESS_ENGINE_BUSY = "chess/engine_busy"
    CHESS_EVALUATION_VALID = "chess/evaluation_valid"
    CHESS_EVALUATION_PAWNS = "chess/evaluation_pawns"
    CHESS_EVALUATION_IS_MATE = "chess/evaluation_is_mate"
    CHESS_MATE_IN = "chess/mate_in"
...
K9_BLACKBOARD_FIELDS: tuple[BlackboardField, ...] = (
    ...
    BlackboardField(
        ...
        str,
        "",
        "Human colour reported by Lichess.",
    ),
    BlackboardField(
        BlackboardKey.CHESS_K9_COLOUR,
        str,
        "",
        "K9 colour reported by Lichess.",
    ),
    BlackboardField(
    ...
    BlackboardField(
        ...
        str,
        "",
        "Authoritative current chess position in FEN.",
    ),
    BlackboardField(
        BlackboardKey.CHESS_PLY,
        int,
        0,
        "Number of half-moves in the current chess game.",
    ),
    BlackboardField(
        BlackboardKey.CHESS_ENGINE_BUSY,
        bool,
        False,
        "Whether the chess engine is currently computing.",
    ),
    BlackboardField(
        BlackboardKey.CHESS_EVALUATION_VALID,
        bool,
        False,
        "Whether a normal pawn evaluation is available.",
    ),
    BlackboardField(
        BlackboardKey.CHESS_EVALUATION_PAWNS,
        float,
        0.0,
        "Stockfish evaluation in pawns from K9's perspective.",
    ),
    BlackboardField(
        BlackboardKey.CHESS_EVALUATION_IS_MATE,
        bool,
        False,
        "Whether the current evaluation is a forced-mate score.",
    ),
    BlackboardField(
        BlackboardKey.CHESS_MATE_IN,
        int,
        0,
        "Signed mate distance from K9's perspective.",
    ),
    BlackboardField(
